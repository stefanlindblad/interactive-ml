...
def cmake_cache_init(build_dir, config=nil)
	...
	content += get_cmake_set_command("TENSORFLOW_SRC_DIR", $tensorflow_src_dir)
	content += get_cmake_set_command("TENSORFLOW_BUILD_DIR", $tensorflow_build_dir)
	content += get_cmake_set_command("TENSORFLOW_PYTHON_DIR", $tensorflow_python_dir)
