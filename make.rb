...
$tensorflow_src_dir = ENV["TF_SRC_DIR"]
$tensorflow_src_dir = $tensorflow_src_dir.gsub("\\", "/")
$tensorflow_build_dir = ENV["TF_BUILD_DIR"]
$tensorflow_build_dir = $tensorflow_build_dir.gsub("\\", "/")
